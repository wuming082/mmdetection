...
# 1. 使用 MMDetection 的注册器
from mmdet.registry import MODELS
from ..layers import InvertedResidual
from ..utils import make_divisible


@MODELS.register_module() # 4. 使用 MMDetection 的注册器注册
class MobileNetV3(BaseModule): # 5. 继承 MMDetection 的 BaseBackbone
    ...
    def __init__(self,
        ...
        # 6. 调用 MMDetection BaseBackbone 的初始化
